...
$$.MediaKeyError = {"": ["Interceptor;code=,systemCode=", function() {
    ...
    return [$.DomName_02, $.Type_cOY, $.Type_0];
  }]};
...
$$.MouseEvent0 = {"": ["UIEvent;altKey=,button=,$$dom_clientX:clientX=,$$dom_clientY:clientY=,ctrlKey=,dataTransfer=,fromElement=,metaKey=,_get_relatedTarget:relatedTarget=,$$dom_screenX:screenX=,$$dom_screenY:screenY=,shiftKey=,toElement=,$$dom_webkitMovementX:webkitMovementX=,$$dom_webkitMovementY:webkitMovementY=", function() {
...
$$.WheelEvent = {"": ["MouseEvent0;directionInvertedFromDevice:webkitDirectionInvertedFromDevice=", function() {
...
$$.Bound_isEmpty_LatLngBounds = {"": "BoundClosure;_self,_target,_receiver",
  call$0: function() {
...
$$.Closure$cast = {"": "Closure;call$1,$name"};
...
JsIsolateSink: {"": "EventSink;_isClosed@,_liblib8$_port<",
  add$1: function(_, message) {
    $.send$1$x(this._liblib8$_port, message);
  },
  "+add:1:0": 0,
  $eq: function(_, other) {
    if (other == null)
      return false;
    return typeof other === "object" && other !== null && !!$.getInterceptor(other).$isIsolateSink && $.$eq(this._liblib8$_port, other.get$_liblib8$_port()) === true;
  },
  "+==:1:0": 0,
  get$hashCode: function(_) {
    return $.$add$ns($.get$hashCode$(this._liblib8$_port), 499);
  },
  "+hashCode": 0,
...
_EventLoop: {"": "Object;events<,activeTimerCount@",
  dequeue$0: function() {
    var t1 = this.events;
    if ($.$eq(t1._liblib1$_head, t1._liblib1$_tail) === true)
      return;
...
IsolateNatives__processWorkerMessage_closure: {"": "Closure;entryPoint_0,replyTo_1",
  call$0: function() {
    ...
    $.register$2$x($._globalState().currentContext, t1._liblib8$_id, t1);
    $.lazyPort = t1;
    if ($.lazyPort == null)
...
_BaseSendPort: {"": "Object;_liblib8$_isolateId<",
  ...
  call$1: function(message) {
    ...
    $.register$2$x($globalState.currentContext, port._liblib8$_id, port);
...
_JsSerializer: {"": "_Serializer;_nextFreeRefId,_visited",
  ...
  visitIsolateSink$1: function(sink) {
    ...
    return ["isolateSink", this.visitSendPort$1(sink._liblib8$_port), isClosed];
  },
  "+visitIsolateSink:1:0": 0,
  visitCloseToken$1: function(token) {
    return ["closeToken"];
...
_JsCopier: {"": "_Copier;_visited",
  ...
  "+visitSendPort:1:0": 0,
  visitIsolateSink$1: function(sink) {
    var result = new $.JsIsolateSink(false, this.visitSendPort$1(sink._liblib8$_port));
...
ReceivePortImpl$: function() {
  ...
  $.ReceivePortImpl__nextFreeId = $.$add$ns(t1, 1);
  t1 = new $.ReceivePortImpl(t1, null);
  $.register$2$x($globalState.currentContext, t1._liblib8$_id, t1);
  return t1;
},
...
Primitives_applyFunction: function($function, positionalArguments, namedArguments) {
  ...
  if (namedArguments != null) {
    ...
    t1 = namedArguments._liblib1$_length !== 0;
  } else
    t1 = false;
  if (t1) {
    ...
    argumentCount += namedArguments._liblib1$_length;
...
["bootstrap", "weatherapp.html_bootstrap.dart", , {
main0: function() {
  $.useObservers = true;
  $.main();
  $.init_autogenerated();
...
TakeWhileIterable: {"": "IterableBase;_iterable<,_f<",
  get$iterator: function(_) {
    var t1, $arguments, arguments0, t2;
    t1 = $.get$iterator$ax(this._iterable);
    $arguments = this.$asTakeWhileIterable;
    arguments0 = $.getRuntimeTypeInfo(this);
    if (typeof $arguments === "object" && $arguments !== null && $arguments.constructor === Array)
      ;
    else
      $arguments = typeof $arguments == "function" ? $arguments.apply(null, arguments0) : arguments0;
    t2 = $arguments == null ? null : $arguments[0];
    t1 = new $.TakeWhileIterator(t1, this._f, false);
    t1.$builtinTypeInfo = [t2];
    return t1;
  },
  "+iterator": 0,
...
_BufferingStreamSubscription: {"": "Object;_onData@,_onError@,_onDone@,_zone<,_state@,_pending@",
  ...
  pause$1: function(_, resumeSignal) {
    ...
    if (t1 === true && $.$eq($.$and$n(this._state, 16), 0) === true)
  ...
  resume$0: function() {
    ...
    if ($.$ge$n(this._state, 64) === true) {
      ...
      if ($.$ge$n(this._state, 64) !== true) {
        if ($.$eq($.$and$n(this._state, 32), 0) !== true) {
        ...
        if (t1)
          ...
          if ($.$eq($.$and$n(this._state, 16), 0) === true)
  ...
  _sendError$1: function(error) {
    ...
    this._state = $.$and$n(this._state, 4294967279);
    if ($.$eq($.$and$n(this._state, 1), 0) !== true) {
      this._state = $.$or$n(this._state, 8);
  ...
  _checkState$1: function(wasInputPaused) {
    ...
    if (typeof wasInputPaused !== "boolean")
      return this._checkState$1$bailout(1, wasInputPaused);
    if ($.$eq($.$and$n(this._state, 32), 0) !== true) {
      t1 = this._pending;
      t1.get$isEmpty;
      t1 = t1.lastPendingEvent == null;
    ...
    if (t1) {
      ...
      if ($.$eq($.$and$n(this._state, 4), 0) !== true)
        if ($.$ge$n(this._state, 64) !== true) {
          t1 = this._pending;
          if (t1 != null) {
            t1.get$isEmpty;
    ...
    for (; true; wasInputPaused = isInputPaused) {
      ...
      isInputPaused = $.$eq($.$and$n(this._state, 4), 0) !== true;
    ...
    if ($.$eq($.$and$n(this._state, 32), 0) !== true && $.$ge$n(this._state, 64) !== true)
      this._pending.schedule$1(this);
  },
  "+_checkState:1:0": 0,
  _checkState$1$bailout: function(state0, wasInputPaused) {
    var t1, isInputPaused;
    if ($.$eq($.$and$n(this._state, 32), 0) !== true) {
      t1 = this._pending;
      t1.get$isEmpty;
    ...
    for (; true; wasInputPaused = isInputPaused) {
      ...
      isInputPaused = $.$eq($.$and$n(this._state, 4), 0) !== true;
      if ($.$eq(wasInputPaused, isInputPaused) === true)
        break;
      this._state = $.$xor$n(this._state, 16);
      if (isInputPaused)
        this._onPause$0();
...
_TakeWhileStream: {"": "_ForwardingStream;_test<,_liblib9$_source",
  _test$1: function(arg0) {
    return this._test.call$1(arg0);
  },
  _handleData$2: function(inputEvent, sink) {
...
_ZoneTimer: {"": "Object;_zone<,_liblib9$_callback<,_timer@,_isDone@",
...
_asyncRunCallback: function() {
  ...
  for (; t1 = $.get$_asyncCallbacks(), $.$eq(t1._liblib1$_head, t1._liblib1$_tail) !== true;) {
...
ListQueue: {"": "IterableBase;_table@,_liblib1$_head@,_liblib1$_tail@,_modificationCount@",
  ...
  forEach$1$bailout1: function(state0, action, modificationCount, i) {
    switch (state0) {
      ...
      case 1:
        var t1;
        state0 = 0;
        for (; $.$eq(i, this._liblib1$_tail) !== true; i = (i + 1 & this._table.length - 1) >>> 0) {
          t1 = this._table;
  ...
  get$first: function(_) {
    var t1, t2;
    if ($.$eq(this._liblib1$_head, this._liblib1$_tail) === true)
      throw $.wrapException(new $.StateError("No elements"));
    t1 = this._table;
  ...
  clear$0$bailout: function(state0, i) {
    switch (state0) {
      ...
      case 1:
        var t1, t2;
        if (state0 === 1 || state0 === 0 && $.$eq(this._liblib1$_head, this._liblib1$_tail) !== true)
          switch (state0) {
            case 0:
              i = this._liblib1$_head;
            case 1:
              state0 = 0;
              for (; $.$eq(i, this._liblib1$_tail) !== true; i = (i + 1 & t2 - 1) >>> 0) {
                t1 = this._table;
                t2 = t1.length;
                if (i >>> 0 !== i || i >= t2)
                  throw $.ioore(i);
    ...
    switch (state0) {
      ...
      case 4:
        ...
        if (state0 === 0 && $.$lt$n(startDistance, $.$and$n($.$sub$n(t1, offset), mask)) === true) {
          for (i = offset; t1 = $.getInterceptor(i), t1.$eq(i, this._liblib1$_head) !== true; i = prevOffset) {
          ...
          switch (state0) {
            ...
            case 4:
              ...
              for (i = offset; t1 = $.getInterceptor(i), t1.$eq(i, this._liblib1$_tail) !== true; i = nextOffset) {
...
_ListQueueIterator: {"": "Object;_queue<,_liblib1$_end<,_modificationCount<,_liblib1$_position@,_liblib1$_current@",
  ...
  moveNext$0: function() {
    ...
    if ($.$eq(this._liblib1$_position, this._liblib1$_end) === true) {
      this._liblib1$_current = null;
      return false;
    }
    t2 = t1._table;
...
Object: {"": ";",
  ...
  getStreamProviderFor$2: function($0, $1) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("getStreamProviderFor", "getStreamProviderFor$2", 0, [$0, $1], []));
  },
  getStreamProviderFor$3: function($0, $1, $2) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("getStreamProviderFor", "getStreamProviderFor$3", 0, [$0, $1, $2], []));
  },
  ...
  isEmpty$0: function($receiver) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("isEmpty", "isEmpty$0", 0, [], []));
  },
...
Uri: {"": "Object;_port@,_path@,scheme<,userInfo<,host>,query>,fragment<,_pathSegments@,_queryParameters@",
  ...
  $eq: function(_, other) {
    ...
    if (typeof other !== "object" || other === null || !$.getInterceptor(other).$isUri)
      return false;
    return $.$eq(this.scheme, other.scheme) === true && $.$eq(this.userInfo, other.userInfo) === true && $.$eq(this.host, other.host) === true && $.$eq(this._port, other._port) === true && $.$eq(this._path, other._path) === true && $.$eq(this.query, other.query) === true && $.$eq(this.fragment, other.fragment) === true;
  },
  "+==:1:0": 0,
  get$hashCode: function(_) {
...
Uri__makeScheme_isSchemeLowerCharacter: {"": "Closure;",
  call$1: function(ch) {
    ...
    if (t1.$lt(ch, 128) === true) {
      ...
      if (typeof t1 !== "number")
        throw $.iae(t1);
      t1 = $.$eq($.$and$n(t2, $.JSInt_methods.$shl(1, t1)), 0) !== true;
    } else
      t1 = false;
    return t1;
  },
...
Uri__normalize: function(component) {
  ...
  for (; $.$lt$n(t1.index_1, $length) === true;)
    if ($.$eq(t6.codeUnitAt$1(component, t1.index_1), 37) === true) {
...
Uri__uriEncode: function(canonicalTable, text, spaceToPlus) {
  ...
  while (true) {
    ...
    if (t3.$lt(ch, 128) === true) {
      ...
      if (typeof t5 !== "number")
        throw $.iae(t5);
      t5 = $.$eq($.$and$n(t4, $.JSInt_methods.$shl(1, t5)), 0) !== true;
      t4 = t5;
    } else
      t4 = false;
    if (t4) {
...
_ListRange: {"": "IterableBase;_liblib7$_source<,_offset<,_liblib7$_length<",
  get$iterator: function(_) {
    ...
    if (typeof t2 !== "number")
      throw $.iae(t2);
    return new $._ListRangeIteratorImpl(this._liblib7$_source, t1 - 1, t1 + t2);
  },
  "+iterator": 0,
  get$length: function(_) {
  ...
  _ListRange$3: function(source, offset, $length) {
    var t1, t2, t3;
    t1 = this._offset;
    if (t1 < 0 || t1 > this._liblib7$_source.length)
    ...
    if (t2 == null)
      throw t2.$add();
    t1 = t2 + t1;
    if (t1 > this._liblib7$_source.length)
      throw $.wrapException(new $.RangeError("value " + t1));
  },
...
codepointsToUtf8: function(codepoints, offset, $length) {
  ...
  for (t1 = new $._ListRangeIteratorImpl(t1, t2, t3), t2 = t1._end, t3 = t1._liblib7$_source, t4 = encoded.length, insertAt = 0; t5 = t1._offset + 1, t1._offset = t5, t5 < t2;) {
    t5 = t1._offset;
    if (t5 !== (t5 | 0))
...
["google_maps", "package:google_maps/google_maps.dart", , {
LatLng: {"": "TypedProxy;$$unsafe",
  toString$0: function(_) {
    return $.toString$0(this.$$unsafe);
  },
  "+toString:0:0": 0
},

LatLngBounds: {"": "TypedProxy;$$unsafe",
  contains$1: function(_, latLng) {
    return $.contains$1$asx(this.$$unsafe, latLng);
  },
  "+contains:1:0": 0,
  isEmpty$0: function(_) {
    return $.isEmpty$0$asx(this.$$unsafe);
  },
  "+isEmpty:0:0": 0,
  get$isEmpty: function(_receiver) {
    return new $.Bound_isEmpty_LatLngBounds(this, "isEmpty$0", _receiver);
  },
  toString$0: function(_) {
    return $.toString$0(this.$$unsafe);
  },
...
GEvent: {"": "TypedProxy;$$unsafe",
  addListener$3: function(instance, eventName, handler) {
    var callback, proxy;
    callback = $.Callback$many(handler, false);
    proxy = this.$$unsafe.addListener$3(instance, eventName, callback);
    return proxy == null ? null : new $.MapsEventListener(new $.GEvent_addListener_closure(callback), proxy);
  },
  "+addListener:3:0": 0,
  removeListener$1: function(listener) {
    if (listener.get$onRelease() != null)
  ...
  getStreamProviderFor$3: function(instance, eventName, transformArguments) {
    ...
    t2 = $.List_List($, [$.StreamController, null]);
    t2.$builtinTypeInfo = [[$.StreamController, null]];
    t1 = new $.SubscribeStreamProvider(new $.GEvent_getStreamProviderFor_closure(t1, this, instance, eventName, transformArguments), new $.GEvent_getStreamProviderFor_closure0(t1, this), t2);
    t1.$builtinTypeInfo = [null];
    return t1;
  },
...
GEvent_addListener_closure: {"": "Closure;callback_0",
  call$0: function() {
    var t1, t2, t3, t4;
    t1 = $.get$_proxiedObjectTable();
    t2 = this.callback_0._liblib10$_id;
    t3 = t1._registry;
    t3.$index(t3, t2);
    t4 = t1._globalIds;
    t4.remove$1(t4, t2);
...
GEvent_getStreamProviderFor_closure: {"": "Closure;box_0,this_1,instance_2,eventName_3,transformArguments_4",
  call$1: function(eventSink) {
    this.box_0.mapsEventListener_0 = this.this_1.addListener$3(this.instance_2, this.eventName_3, new $.GEvent_getStreamProviderFor__closure(this.transformArguments_4, eventSink));
  },
  "+call:1:0": 0,
  $isFunction: true
},
...
GEvent_getStreamProviderFor__closure: {"": "Closure;transformArguments_5,eventSink_6",
  call$5: function(p1, p2, p3, p4, p5) {
    var t1, $arguments, arguments0, t2, args, value;
    t1 = new $.TakeWhileIterable([p1, p2, p3, p4, p5], new $.GEvent_getStreamProviderFor___closure());
    t1.$builtinTypeInfo = [null];
    ...
    if (typeof $arguments === "object" && $arguments !== null && $arguments.constructor === Array)
      ...
      $arguments = typeof $arguments == "function" ? $arguments.apply(null, arguments0) : arguments0;
    t2 = $arguments == null ? null : $arguments[0];
    args = $.List_List$from(t1, false, t2);
    t1 = $.getInterceptor$asx(args);
    if ($.$eq(t1.get$length(args), 0) === true)
      value = null;
    else
      value = $.$eq(t1.get$length(args), 1) === true ? t1.get$first(args) : args;
    t1 = this.transformArguments_5;
    t1 = t1 == null ? value : $.Primitives_applyFunction(t1, args, $.Function__toMangledNames(null));
    $.add$1$ax(this.eventSink_6, t1);
  },
  "+call:0:5": 0,
  call$3: function(p1, p2, p3) {
    return this.call$5(p1, p2, p3, $.C__Undefined0, $.C__Undefined0);
  },
  call$1: function(p1) {
    return this.call$5(p1, $.C__Undefined0, $.C__Undefined0, $.C__Undefined0, $.C__Undefined0);
  },
  call$4: function(p1, p2, p3, p4) {
    return this.call$5(p1, p2, p3, p4, $.C__Undefined0);
  },
  call$2: function(p1, p2) {
    return this.call$5(p1, p2, $.C__Undefined0, $.C__Undefined0, $.C__Undefined0);
  },
  call$0: function() {
    return this.call$5($.C__Undefined0, $.C__Undefined0, $.C__Undefined0, $.C__Undefined0, $.C__Undefined0);
  },
  $isFunction: true,
  $is_AsyncCallback: true
},
...
GEvent_getStreamProviderFor___closure: {"": "Closure;",
  call$1: function(e) {
    return $.$eq(e, $.C__Undefined0) !== true;
  },
  "+call:1:0": 0,
  $isFunction: true
},
...
GEvent_getStreamProviderFor_closure0: {"": "Closure;box_0,this_7",
  call$1: function(eventSink) {
    ...
    t1.onRelease;
    t1.onRelease$0();
    this.this_7.get$$$unsafe().removeListener$1(t1);
  },
  "+call:1:0": 0,
  $isFunction: true
},

MapsEventListener: {"": "TypedProxy;onRelease<,$$unsafe",
...
GMap: {"": "MVCObject;_onBoundsChanged@,_onCenterChanged@,_onClick@,_onDblClick@,_onDrag@,_onDragend@,_onDragstart@,_onHeadingChanged@,_onIdle@,_onMaptypeidChanged@,_onMousemove@,_onMouseout@,_onMouseover@,_onProjectionChanged@,_onResize@,_onRightclick@,_onTilesloaded@,_onTiltChanged@,_onZoomChanged@,$$unsafe",
  _initStreams$0: function() {
    ...
    this._onClick = $.get$event().getStreamProviderFor$3(this, "click", $.MouseEvent_cast$closure);
    this._onDblClick = $.get$event().getStreamProviderFor$3(this, "dblclick", $.MouseEvent_cast$closure);
    ...
    this._onMousemove = $.get$event().getStreamProviderFor$3(this, "mousemove", $.MouseEvent_cast$closure);
    this._onMouseout = $.get$event().getStreamProviderFor$3(this, "mouseout", $.MouseEvent_cast$closure);
    this._onMouseover = $.get$event().getStreamProviderFor$3(this, "mouseover", $.MouseEvent_cast$closure);
    ...
    this._onRightclick = $.get$event().getStreamProviderFor$3(this, "rightclick", $.MouseEvent_cast$closure);
...
MapOptions: {"": "TypedProxy;$$unsafe",
  set$center: function(center) {
    $.$indexSet$ax(this.$$unsafe, "center", center);
    return center;
  },
  "+center=": 0,
  set$mapTypeId: function(mapTypeId) {
    $.$indexSet$ax(this.$$unsafe, "mapTypeId", mapTypeId);
    return mapTypeId;
  },
  "+mapTypeId=": 0,
  set$zoom: function(zoom) {
    $.$indexSet$ax(this.$$unsafe, "zoom", zoom);
    return zoom;
  },
  "+zoom=": 0
},
...
MapTypeId: {"": "IsEnum;value",
  ...
  "+==:1:0": 0,
  $isMapTypeId: true,
  $asSerializable: function() { return [$.JSString]; }
},

MVCObject: {"": "TypedProxy;$$unsafe"},

MouseEvent_cast: function(proxy) {
  return proxy == null ? null : new $.MouseEvent(proxy);
}}],
...
Callback: {"": "Object;_manualDispose@,_liblib10$_id@,_liblib10$_callback@",
  toJs$0: function() {
  ...
  Callback$many$2$withThis: function(f, withThis) {
    var t1, t2, t3, t4, id;
    this._liblib10$_callback = new $.Callback$many_closure(f, withThis);
    this._manualDispose = true;
    t1 = $.get$_proxiedObjectTable();
    t2 = this._liblib10$_callback;
    $._enterScopeIfNeeded();
    t3 = t1._liblib10$_name + "-";
    t4 = t1._nextId;
    t1._nextId = t4 + 1;
    id = t3 + $.S(t4);
    t4 = t1._registry;
...
Proxy: {"": "Object;_liblib10$_port@,_liblib10$_id<",
  ...
  noSuchMethod$1: function(_, invocation) {
    ...
    if (invocation.get$isGetter() === true)
      ...
      kind = $.$eq(member, "call") === true ? "apply" : "method";
...
_deserialize_deserializeFunction: {"": "Closure;",
  call$1: function(message) {
    ...
    if ($.$eq(port, new $._LocalSendPortSync($.get$_proxiedObjectTable()._liblib10$_port)) === true) {
...
["js.wrapping", "package:js/js_wrapping.dart", , {
TypedProxy: {"": "Object;$$unsafe<",
  toJs$0: function() {
    return this.$$unsafe;
  },
  "@toJs$0": function() {
...
["utils", "package:google_maps/src/utils.dart", , {
IsEnum: {"": "Object;value*",
  toJs$0: function() {
    return this.value;
  },
...
SubscribeStreamProvider_add_closure: {"": "Closure;event_0",
  call$1: function(controller) {
    return $.add$1$ax(controller, this.event_0);
  },
  "+call:1:0": 0,
  $isFunction: true
}}],
...
WeatherStationClient: {"": "WeatherStation_Observable;__$_stationId@,__$updateInProgress@,__$updatePeriod@,__$nextUpdateString@,_liblib11$__$count@,$$_observers,$$_changes,hashCode,stationName,latitute,longitude,nextUpdate,lastSampled,readings",
  ...
  set$_stationId: function(value) {
    ...
    if (t1 != null) {
      ...
      t1 = false;
    if (t1)
      $.notifyChange(this, 1, "_stationId", this.__$_stationId, value);
    this.__$_stationId = value;
  },
  "+_stationId=": 0,
  get$updateInProgress: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "updateInProgress");
  ...
  read$0: function() {
    ...
    if (t1 != null) {
      ...
      t1 = false;
    if (t1)
      $.notifyChange(this, 1, "updateInProgress", this.__$updateInProgress, true);
    this.__$updateInProgress = true;
    t1 = $.JSInt;
    t2 = new $._FutureImpl(0, $.get$_Zone__current().fork$0(), null);
    t2.$builtinTypeInfo = [t1];
    comp = new $._AsyncCompleter(t2, false);
...
WeatherStationClient_read_closure: {"": "Closure;this_0,comp_1",
  call$0: function() {
    ...
    t1 = this.this_0;
    t2 = t1.get$readings();
    value = new $.AnemometerReading(null, null, null, null, null, null, null);
    t3 = new $.DateTime(Date.now(), false);
    $.Primitives_lazyAsJsDate(t3);
    value.timeStamp = t3;
    $.add$1$ax(t2, value);
    t2 = t1.get$$$_observers();
    if (t2 != null) {
      t2.get$head;
      t2 = t2.get$_head() != null;
    } else
      t2 = false;
    if (t2)
      $.notifyChange(t1, 1, "updateInProgress", t1.get$__$updateInProgress(), false);
    t1.set$__$updateInProgress(false);
    t2 = this.comp_1;
    t3 = $.get$length$asx(t1.get$readings());
    if (t2._isComplete)
      $.throwExpression(new $.StateError("Future already completed"));
    t2._isComplete = true;
    t2.future._zone.cancelCallbackExpectation$0();
...
["weatherapp_html", "weatherapp.dart", , {
init_autogenerated_closure0: {"": "Closure;",
  call$0: function() {
    var t1 = $.weatherStations.stations;
    if (0 >= t1.length)
      throw $.ioore(0);
    return t1[0];
  },
...
init_autogenerated_closure: {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$xtag$x(t1.__e0_0).get$station(), e) !== true)
      $.get$xtag$x(t1.__e0_0).set$station(e);
  },
  "+call:1:0": 0,
  $isFunction: true
},
...
main: function() {
  var t1, t2, value, mapOptions;
  if ($.WeatherStations__instance == null) {
    t1 = new $.WeatherStations(null, null, null, null);
    t2 = $.List_List($, $.WeatherStationClient);
    t2.$builtinTypeInfo = [$.WeatherStationClient];
    t1.stations = t2;
    t2 = t1.stations;
    value = $.WeatherStationClient$();
    value.set$_stationId(1);
    value.stationName = "station 1";
    t2.push(value);
    t2 = t1.stations;
    value = $.WeatherStationClient$();
    value.set$_stationId(2);
    value.stationName = "station 2";
    t2.push(value);
    t1._startReaderThreads$0();
    $.WeatherStations__instance = t1;
  }
  $.weatherStations = $.WeatherStations__instance;
  $._enterScopeIfNeeded();
  t1 = $._deserialize($._jsPortSync.callSync$1([])).get$Object();
  mapOptions = new $.MapOptions($.Proxy_Proxy$withArgList(t1, []));
  mapOptions.set$zoom(14);
  t1 = $.get$maps().get$LatLng();
  t2 = [50.724321, -1.741471, null];
  if (t1 != null)
    ;
  else {
    $._enterScopeIfNeeded();
  ...
  mapOptions.set$center(new $.LatLng($.Proxy_Proxy$withArgList(t1, t2)));
  mapOptions.set$mapTypeId($.get$MapTypeId_ROADMAP());
  t1 = $.get$maps().get$LatLng();
  t2 = [50.740067, -1.50677, null];
  if (t1 != null)
    ;
  else {
    $._enterScopeIfNeeded();
  ...
  $.Proxy_Proxy$withArgList(t1, t2);
  t1 = document.querySelector("#map_canvas");
  t2 = $.get$maps().get$Map();
  t1 = [t1, mapOptions];
  ...
  if (t2 != null)
    ...
    $._enterScopeIfNeeded();
    t2 = $._deserialize($._jsPortSync.callSync$1([])).get$Object();
  }
  new $.GMap(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, $.Proxy_Proxy$withArgList(t2, t1))._initStreams$0();
  t1 = $.get$maps().get$LatLngBounds();
  t2 = [null, null];
  if (t1 != null)
    ;
  else {
...
StationViewer: {"": "WebComponent_Observable;_css@,__e10@,__e2@,__e4@,__e6@,__e8@,__t@,__$count@,__$station@,$$_observers,$$_changes,hashCode,_host,_shadowRoots,_generatedRoots,_mapper",
  created_autogenerated$0: function() {
    ...
    this._mapper = new $.ScopedCssMapper($.makeLiteralMap(["x-station_viewer", "[is=\"x-station_viewer\"]"]));
  ...
  get$station: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this, 1, "station");
    return this.__$station;
  },
  "+station": 0,
  set$station: function(value) {
    var t1 = this.get$$$_observers();
    if (t1 != null) {
      t1.get$head;
      t1 = t1._head != null;
      ...
      t1 = false;
    if (t1)
      $.notifyChange(this, 1, "station", this.__$station, value);
    this.__$station = value;
  },
  "+station=": 0
},
...
$.MouseEvent_cast$closure = new $.Closure$cast($.MouseEvent_cast, "MouseEvent_cast$closure");
...
$.C__ObservableAnnotation = new $._ObservableAnnotation();
...
$.DomName_04 = new $.DomName("MIDIPort.manufacturer");
...
$.DomName_PrM0 = new $.DomName("Node.insertBefore");
...
$.DomName_03 = new $.DomName("MediaKeyNeededEvent.initData");
...
$.useObservers = false;
$._watchers = null;
$.WeatherStations__instance = null;
...
//@ sourceMappingURL=weatherapp.html_bootstrap.dart.js.map
